"""Create user_entity_access table for multi-entity user management

Revision ID: create_user_entity_access_v1
Revises: add_entity_slug_status_v1
Create Date: 2026-02-13

Creates user_entity_access table to manage which users can access which entities.
This enables multi-entity access control.
"""
...
revision = "create_user_entity_access_v1"
down_revision = "add_entity_slug_status_v1"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    if "user_entity_access" in insp.get_table_names():
        return  # already applied (e.g. table created manually or re-run)
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Text(), nullable=False, server_default="viewer"),  # admin, editor, viewer
