// apps/web/src/app/[entitySlug]/scorecard/[projectId]/dashboard/kpis_admin/kpi_list/page.tsx
...
export default async function EntityKpiListReportPage({
  params,
}: {
                  ...
                  {pillar.kpis.map((kpi) => (
                    <li key={kpi.kpi_name}>
                      <div className="text-sm text-slate-800 dark:text-slate-100">
                        ...
                        {kpi.kpi_description ? ` – ${kpi.kpi_description}` : ""}
                      </div>
