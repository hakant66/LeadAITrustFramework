...
export default function Iso42001LandingPage({
  ...
  const base = `/${encodeURIComponent(entitySlug)}`;
  const items = [
    {
      label: "Scope - The Boundary",
      href: `${base}/scorecard/admin/governance-setup/aims-scope`,
    },
    {
      label: "Pillar Admin",
      href: `${base}/scorecard`,
    ...
    },
    {
      ...
      href: `${base}/scorecard/admin/governance-setup/ai-policy-register`,
    },
    {
      label: "Policy Execution",
      href: `${base}/scorecard/admin/governance-execution/policy-execution`,
    },
  ];
