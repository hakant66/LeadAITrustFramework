...
const PROMPT_KEY = "governance_requirements_report";
...
export default function GovReqReportPromptPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      <div className="mx-auto max-w-6xl px-6 py-6">
        <Header title="Gov. Req. Report Prompt" subtitle="System Admin" />
          ...
          <div className="space-y-6">
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">
                    {template?.name ?? "Governance Requirements Report"}
                  </div>
              ...
              <div className="mt-4">
                ...
                <textarea
                  className="mt-2 h-72 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm"
                  value={draftText}
