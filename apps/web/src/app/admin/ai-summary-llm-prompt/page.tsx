...
const PROMPT_KEY = "ai_summary_llm";
...
export default function AiSummaryLlmPromptPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      <div className="mx-auto max-w-6xl px-6 py-6">
        <Header title="Executive Report Prompt" subtitle="System Admin" />
              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">
                    {template?.name ?? "Executive / AI Project Summary (LLM)"}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400">
                    {template?.description ?? ""}
                  </div>
                  <div className="mt-1 text-xs text-slate-400 dark:text-slate-500">
                    Variables: $Project Name, $Project Slug, $Overall Score, $Pillar Performance, $Lowest Performing KPIs
                  </div>
                </div>
                {active ? (
                  <div className="text-xs text-slate-500 dark:text-slate-400">
